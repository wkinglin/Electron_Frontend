  ...
  <div id="main">
    <el-card class="box-card" v-loading="loading">
      <div style="height:40px;">
        <span style="float:left;">联合作战模型</span>
        <div>
      ...
      <el-form id="form" ref="form" :model="form" label-position="left" label-width="160px">
        ...
        <el-form-item label="选择模型">
          <el-select v-model="form.name" placeholder="请选择模型">
            <el-option label="联合作战模型" value="lianhe"></el-option>
            <el-option label="飞机模型" value="feiji"></el-option>
            <el-option label="2-3" value="2-3"></el-option>
            <el-option label="3-1-4" value="3-1-4"></el-option>
